...
const satoriContent = `    (
      ...
      >
        ...
        {coverImageSrc && (
          <div
            style={{
              ...
              width: "1200px",
              height: "630px",
              backgroundColor: "rgba(14, 26, 43, 0.85)",
              zIndex: 1,
            }}
          />
        )}
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", zIndex: 2, width: "100%" }}>
          <div style={{ fontSize: 64, fontWeight: "bold", lineHeight: 1.1, color: "white", marginBottom: "24px" }}>
            {post.title}
          </div>
          <div style={{ fontSize: 32, color: "#cbd5e1", lineHeight: 1.4 }}>
