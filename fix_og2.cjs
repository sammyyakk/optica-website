...
// Find the return new ImageResponse(... and replace to the end.
const startIdx = file.indexOf('return new ImageResponse(');
if (startIdx !== -1) {
  file = file.substring(0, startIdx) + satoriContent + '\n}\n';
