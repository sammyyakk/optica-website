...
interface Event {
  ...
  description: string;
  image: string;
  category: 'ideathon' | 'seminar' | 'quiz' | 'debate' | 'visit' | 'competition';
}
...
const mockEvents: Event[] = [
  {
    ...
    date: '2024-10-15',
    description: 'A 24-hour ideathon focused on quantum computing and photonics innovations.',
  ...
  },
  {
    ...
    date: '2024-09-22',
    description: 'Expert speakers discussing the intersection of artificial intelligence and optical systems.',
  ...
  },
  {
    ...
    date: '2024-08-10',
    description: 'Test your knowledge in quantum mechanics, optics, and photonics.',
  ...
  },
  {
    ...
    date: '2024-06-05',
    description: 'Educational visit to the Aryabhatta Research Institute of Observational Sciences.',
  ...
  },
  {
    ...
    date: '2024-05-12',
    description: 'Robotics competition featuring autonomous and remote-controlled challenges.',
