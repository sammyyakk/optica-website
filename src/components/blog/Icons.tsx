  ...
  return (
    ...
    >
      ...
      <circle
        ...
        cy="5"
        r="1"
        className="stroke-violet-300 fill-violet-400/30"
      />
    </svg>
  );
}
...
export function PartyIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M22 2l-2.24.75a1 1 0 00-.64.64L18.38 5.6a1 1 0 01-.64.64L15.5 7"
        className="stroke-rose-300"
      />
      <path
        d="M8.56 2.75a1 1 0 01.64-.64L12 1l.75 2.24a1 1 0 01-.64.64L9.87 4.63"
        className="stroke-pink-300"
      />
      <path
        d="M19.13 12l2.24.75a1 1 0 01.64.64L22.75 16l-2.24.75"
...
export function FlaskIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M10 3v7.4a2 2 0 01-.6 1.4L4 17.2a2 2 0 00-.6 1.4V20a2 2 0 002 2h13.2a2 2 0 002-2v-1.4a2 2 0 00-.6-1.4L14.6 11.8a2 2 0 01-.6-1.4V3"
...
export function LightbulbIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    ...
    >
      <path
        d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 006 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"
...
export function PinIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M5 17h14v-1.76a2 2 0 00-1.11-1.79l-1.78-.89A2 2 0 0115 10.76V6h1a2 2 0 000-4H8a2 2 0 000 4h1v4.76a2 2 0 01-1.11 1.79l-1.78.89A2 2 0 005 15.24z"
...
export function QuillIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    ...
    >
      <path
        d="M20 4c-1 1-3.5 1.5-5 1l-1 1c3 2 4 6 3 10l-2-1c0-3-1-5-3-7l-1 1c1.5 2 2 4 1.5 6L10 14c.5-2.5 0-5-2-7L7 8c1 3 .5 6-1 8l-2-1c.5-2 .5-4 0-6L3 11"
        className="stroke-purple-400"
      />
      <path
        d="M4.5 16.5c-1.5 1.5-2 4-2 4s2.5-.5 4-2"
        className="stroke-pink-400"
      />
    </svg>
  );
