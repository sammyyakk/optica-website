...
import { CATEGORY_COLORS, type BlogPost } from "@/lib/blog/types";
import {
  CategoryIcon,
  PinIcon,
  FileTextIcon,
        ...
        <div className="relative z-10 pt-20 flex items-center justify-center min-h-screen">
          <div className="text-center">
            <div className="mb-4 flex justify-center">
              <FileTextIcon className="w-14 h-14 text-purple-400" />
            </div>
            ...
            <AnimatedSection className="flex-1 min-w-0" delay={0.15} amount={0.01}>
              ...
              <div className="mt-8 p-4 bg-white/5 rounded-xl border border-purple-500/20">
                <h4 className="text-sm font-heading text-white mb-2 flex items-center gap-1.5">
                  <CodeIcon className="w-4 h-4 text-purple-400" /> Embed this
                  article
                </h4>
