...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BVP Optica Website OptiArchitects",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: `${siteUrl}/optiarchitects`,
  },
};
