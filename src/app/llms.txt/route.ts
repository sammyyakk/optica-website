...
export async function GET() {
  ...
  lines.push("");
  lines.push(
    "> Student tech chapter at Bharati Vidyapeeth's College of Engineering (BVCOE), New Delhi, and Optica's (formerly OSA — the Optical Society of America) chapter on campus. Builds and innovates across AI, machine learning, cybersecurity, robotics, blockchain, and optics through workshops, seminars, research, ideathons, and community events, as part of Optica's global network of student chapters.",
  );
  lines.push("");
  lines.push(
