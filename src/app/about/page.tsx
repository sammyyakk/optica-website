      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          <RevealElement direction="left" delay={0.3}>
            <div className="bg-surface rounded-card shadow-card p-8 border border-optica-purple/15">
              <h2 className="font-heading text-3xl font-bold mb-4 text-quantum-violet">
                Our Mission
              </h2>
        ...
        <RevealElement direction="up" delay={0.4}>
          <h2 className="font-heading text-4xl font-bold text-center mb-12 text-quantum-violet">
            What We Do
          </h2>
        </RevealElement>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {[
            ...
            <RevealElement key={index} direction="up" delay={0.5 + index * 0.1}>
              <div className="bg-surface rounded-card shadow-card p-6 border border-optica-purple/15 hover:border-quantum-violet/40 hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
                <div className="text-5xl mb-4">{item.icon}</div>
                <h3 className="font-heading text-xl font-bold mb-3 text-text-primary group-hover:text-quantum-violet transition-colors">
                  {item.title}
                </h3>
        ...
        <RevealElement direction="up" delay={0.9}>
          <div className="max-w-4xl mx-auto bg-surface rounded-card shadow-card p-8 border border-optica-purple/20">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="w-48 h-48 rounded-full bg-gradient-to-br from-optica-purple to-quantum-violet flex items-center justify-center text-white font-heading text-6xl">
                Dr. P
              </div>
              <div className="flex-1">
                <h3 className="font-heading text-3xl font-bold mb-4 text-quantum-violet">
                  Dr. Yugnanda Puri
                </h3>
