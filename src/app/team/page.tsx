  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-background-dark/80 rounded-card shadow-card p-6 border border-transparent dark:border-quantum-violet/20 hover:shadow-2xl transition-all duration-300">
        {/* Avatar Placeholder */}
        <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-optica-blue to-quantum-violet flex items-center justify-center overflow-hidden">
        ...
        {/* Member Info */}
        <h3 className="font-heading text-xl font-bold text-center text-text-primary dark:text-white mb-2 group-hover:text-optica-blue dark:group-hover:text-quantum-violet transition-colors">
          {member.name}
        </h3>
        <p className="font-accent text-sm text-center text-quantum-violet dark:text-photon-gold mb-4">
          {member.role}
        </p>
        ...
        <div className="flex gap-4 justify-center">
          {member.linkedin && (
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 rounded-full bg-optica-blue dark:bg-quantum-violet flex items-center justify-center text-white hover:bg-quantum-violet dark:hover:bg-photon-gold transition-colors"
            >
          ...
          {member.instagram && (
            <motion.a
              ...
              whileHover={{ scale: 1.2, rotate: -5 }}
              whileTap={{ scale: 0.9 }}
              className="w-10 h-10 rounded-full bg-laser-magenta dark:bg-photon-gold flex items-center justify-center text-white hover:bg-photon-gold dark:hover:bg-laser-magenta transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom Accent */}
        <div className="mt-6 h-1 bg-gradient-to-r from-optica-blue via-quantum-violet to-photon-gold transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
      </div>
    </motion.div>
  );
}
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <RevealElement direction="up" delay={0.3}>
          <h2 className="font-heading text-3xl font-bold text-center mb-10 text-quantum-violet dark:text-photon-gold">
            Core Team
          </h2>
        </RevealElement>
