...
import { CategoryIcon, PinIcon, FileTextIcon, CodeIcon } from "@/components/blog/Icons";
      ...
      <main className="min-h-screen bg-transparent text-white overflow-hidden">
        ...
        <div className="relative z-10 pt-20 flex items-center justify-center min-h-screen">
          <div className="text-center">
            <div className="mb-4 flex justify-center"><FileTextIcon className="w-14 h-14 text-purple-400" /></div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
          ...
          <AnimatedSection className="mb-8" delay={0.05}>
            <div className="flex flex-wrap items-center gap-2 mb-4">
              <span
                className={`px-3 py-1 text-xs font-medium rounded-full bg-gradient-to-r ${CATEGORY_COLORS[post.category]} text-white inline-flex items-center gap-1`}
              >
                <CategoryIcon category={post.category} className="w-3.5 h-3.5" /> {post.category}
              </span>
              {post.pinned && (
          ...
          <div className="flex gap-10">
            ...
            <AnimatedSection className="flex-1 min-w-0" delay={0.15}>
              ...
              <div className="mt-8 p-4 bg-white/5 rounded-xl border border-purple-500/20">
                <h4 className="text-sm font-heading text-white mb-2 flex items-center gap-1.5">
                  <CodeIcon className="w-4 h-4 text-purple-400" /> Embed this article
                </h4>
                    ...
                    <article className="bg-gradient-to-br from-purple-900/30 via-black/40 to-purple-900/20 backdrop-blur-sm rounded-xl border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 overflow-hidden">
                      <div className="relative h-36">
                        {rp.coverImage ? (
                          ...
                          <CategoryIcon category={rp.category} className="w-10 h-10" />
                          </div>
                        )}
